/**
 * \file TerrainVague.java
 * \brief La Classe TerrainVague
 * \author Teng FAN
 * \version 1.0
...
public class TerrainVague extends Case {	
	 ...
	 *  @return rien
	 */
	public TerrainVague(String nom, Point point, double niveauContamination, int capacite) 
	{
		super(nom, point, niveauContamination, capacite);
		super.setFonction("TerrainVague");
	 ...
	 *  @return rien
	 */
	public TerrainVague(String nom, Point point, double niveauContamination, int capacite, String fonction) 
	{
		super(nom, point, niveauContamination, capacite);
	...
	public static void main(String[] args)
	{
		...
		int capacite = 2;
		Case c = new TerrainVague("Chales",point_test,niveauContamination_test,capacite);		
