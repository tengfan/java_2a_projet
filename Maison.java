...
public class Maison extends Case {
	/** @brief Constructeur
	 *  @since 1.0.0
	 *  @param  String <b>nom</b> Le nom int [] <b>point</b> Coordonnees de la case double <b>niveauContamination</b> Le niveau de contamination int <b>capacite</b> La capacite de la case 
	 *  @return rien
	 */
	public Maison(String nom, Point point, double niveauContamination, int capacite) 
	{
		super(nom, point, niveauContamination, capacite);
		super.setFonction("Maison");
	 ...
	 *  @return rien
	 */
	public Maison(String nom, Point point, double niveauContamination, int capacite, String fonction) 
	{
		super(nom, point, niveauContamination, capacite);
	...
	public static void main(String[] args)
	{
		...
		int capacite = 2;
		Case c = new Maison("Chales",point_test,niveauContamination_test,capacite);		
