...
public class Caserne extends Case {
	 ...
	 *  @return rien
	 */
	public Caserne(String nom, Point point, double niveauContamination, int capacite) 
	{
		super(nom, point, niveauContamination, capacite);
		super.setFonction("Caserne");
	 ...
	 *  @return rien
	 */
	public Caserne(String nom, Point point, double niveauContamination, int capacite, String fonction) 
	{
		super(nom, point, niveauContamination, capacite);
	...
	public static void main(String[] args)
	{
		...
		int capacite = 2;
		Case c = new Caserne("Chales",point_test,niveauContamination_test,capacite);		
